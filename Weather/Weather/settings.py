...
SECRET_KEY = 'django-insecure-bakofxktt*#4ic=8_4(wfhxghfpcmriy#_ofdz)&al8-bpc&fh'
...
# Password validation
# https://docs.djangoproject.com/en/4.2/ref/settings/#auth-password-validatorssth
